export default {
  ...
  checkin: {
    ...
    subtitle: 'Check in every day to earn a bonus balance reward.',
    checkIn: 'Check in',
    checkedInToday: 'Checked in today',
    comeBackTomorrow: 'Come back tomorrow for your next reward',
    unavailable: 'Not available right now',
    streakLabel: '🔥 {streak} day streak',
    rangeHint: 'Earn {min}–{max} per day',
    rewardToast: 'You received {amount}!',
    errAlreadyClaimed: 'You have already checked in today.',
  ...
  admin: {
    ...
    accounts: {
      ...
      kiro: {
        accountTypeOauthTitle: 'OAuth',
        accountTypeApikeyTitle: 'API Key',
        oauthHint: 'Kiro OAuth accounts authenticate with a refresh token (Anthropic-compatible). The server manages token expiry automatically.',
        authMethodLabel: 'Authentication Method',
        authMethodSocial: 'Social (Builder ID)',
        ...
        refreshTokenHint: 'Required. Used to refresh access tokens automatically.',
        profileArnLabel: 'Profile ARN (optional)',
        profileArnPlaceholder: 'arn:aws:codewhisperer:...',
        profileArnHint: 'Optional CodeWhisperer/Kiro profile ARN.',
        clientIdLabel: 'Client ID',
        clientIdPlaceholder: 'IdC client ID',
        ...
        authRegionPlaceholder: 'us-east-1',
        apiRegionLabel: 'API Region (optional)',
        apiRegionPlaceholder: 'us-east-1',
        machineIdLabel: 'Machine ID (optional)',
        machineIdPlaceholder: 'Optional machine identifier',
        advancedLabel: 'Advanced options',
        apiKeyLabel: 'Kiro API Key',
        apiKeyPlaceholder: 'Paste the Kiro API key',
        apiKeyHint: 'Required. The Kiro API key is used directly for authentication.',
        editSecretKeepHint: 'Leave blank to keep the existing value.',
        errors: {
