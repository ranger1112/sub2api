export default {
  ...
  checkin: {
    title: '每日签到',
    subtitle: '每天签到即可获得余额奖励。',
    checkIn: '签到领取',
    checkedInToday: '今日已签到',
    comeBackTomorrow: '明日再来领取奖励',
    unavailable: '暂时无法签到',
    streakLabel: '🔥 连续签到 {streak} 天',
    rangeHint: '每日可得 {min}–{max}',
    rewardToast: '成功获得 {amount}！',
    errAlreadyClaimed: '您今日已经签到过了。',
  ...
  admin: {
    ...
    accounts: {
      ...
      kiro: {
        ...
        oauthHint: 'Kiro OAuth 账号使用 refresh token 认证（兼容 Anthropic）。令牌过期时间由服务端自动管理。',
        ...
        refreshTokenHint: '必填。用于自动刷新 access token。',
        profileArnLabel: 'Profile ARN（可选）',
        profileArnPlaceholder: 'arn:aws:codewhisperer:...',
        profileArnHint: '可选的 CodeWhisperer/Kiro profile ARN。',
        ...
        apiRegionLabel: 'API Region（可选）',
        apiRegionPlaceholder: 'us-east-1',
        machineIdLabel: 'Machine ID（可选）',
        machineIdPlaceholder: '可选的机器标识',
        advancedLabel: '高级选项',
        apiKeyLabel: 'Kiro API Key',
        apiKeyPlaceholder: '粘贴 Kiro API Key',
        apiKeyHint: '必填。Kiro API Key 将直接用于认证。',
        editSecretKeepHint: '留空则保留原有值。',
        errors: {
