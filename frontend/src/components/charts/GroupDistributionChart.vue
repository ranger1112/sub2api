            ...
            <template v-for="group in displayGroupStats" :key="group.group_id">
              ...
              >
                <td
                  ...
                  :class="enableBreakdown && group.group_id > 0 ? 'text-gray-900 hover:text-primary-600 dark:text-white dark:hover:text-primary-400' : 'text-gray-900 dark:text-white'"
    ...
    datasets: [
      {
        ...
        backgroundColor: displayGroupStats.value.map((_, i) => distributionColor(i)),
