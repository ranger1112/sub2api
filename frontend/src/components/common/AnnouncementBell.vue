    ...
    <Teleport to="body">
      <Transition name="modal-fade">
        ...
        >
          ...
          >
            <!-- Header -->
            <div class="relative overflow-hidden border-b border-gray-100/80 px-6 py-5 dark:border-white/[0.07]">
              <div class="relative z-10 flex items-start justify-between">
                ...
                <div class="flex items-center gap-2">
                  <button
                    ...
                    @click="markAllAsRead"
                    :disabled="loading"
                    class="rounded-lg bg-primary-500 px-4 py-2 text-xs font-medium text-white transition-colors hover:bg-primary-600 disabled:opacity-50 dark:bg-primary-600 dark:hover:bg-primary-500"
                  >
            ...
            <div class="max-h-[65vh] overflow-y-auto">
              ...
              <div v-else-if="announcements.length > 0">
                <div
                  ...
                  :class="{ 'bg-primary-50/40 dark:bg-primary-500/[0.05]': !item.read_at }"
                ...
                >
                  ...
                  <div class="flex h-10 w-10 flex-shrink-0 items-center justify-center">
                    <div
                      v-if="!item.read_at"
                      class="relative flex h-10 w-10 items-center justify-center rounded-xl bg-primary-500 text-white"
                    >
                      <!-- Pulse ring -->
    ...
    <Teleport to="body">
      <Transition name="modal-fade">
        ...
        >
          ...
          >
            <!-- Header -->
            <div class="relative overflow-hidden border-b border-gray-100 px-8 py-6 dark:border-white/[0.07]">
                  ...
                  <div class="mb-3 flex items-center gap-2">
                    ...
                    <div class="flex items-center gap-2">
                      ...
                      <span
                        ...
                        class="inline-flex items-center gap-1.5 rounded-lg bg-primary-500 px-2.5 py-1 text-xs font-medium text-white"
                      >
              ...
              <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                  ...
                  <button
                    ...
                    class="rounded-xl bg-primary-500 px-5 py-2.5 text-sm font-medium text-white transition-all hover:bg-primary-600 hover:shadow-lg"
                  >
...
.markdown-body code {
  @apply rounded-lg bg-gray-100 px-2 py-1 text-[13px] font-mono text-primary-600 dark:bg-dark-700 dark:text-primary-400;
}
...
.markdown-body th {
  @apply bg-gray-50 font-semibold text-gray-900 dark:bg-dark-800/60 dark:text-white;
}
