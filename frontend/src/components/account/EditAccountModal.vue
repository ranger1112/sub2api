  ...
  >
    ...
    >
      ...
      <div v-if="account.platform === 'kiro'" class="space-y-4">
        <template v-if="account.type === 'oauth'">
          <div>
            ...
            <div class="mt-2 grid grid-cols-1 gap-3 sm:grid-cols-3">
              ...
              <button
                type="button"
                @click="editKiroAuthMethod = 'idc'"
                :class="[
                  'flex items-center gap-3 rounded-lg border-2 p-3 text-left transition-all',
                  editKiroAuthMethod === 'idc'
                    ? 'border-teal-500 bg-teal-50 dark:bg-teal-900/20'
                    : 'border-gray-200 hover:border-teal-300 dark:border-dark-600 dark:hover:border-teal-700'
                ]"
              >
          ...
          <div v-if="editKiroAuthMethod === 'idc'" class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              ...
              <input v-model="editKiroRegion" type="text" class="input font-mono" :placeholder="t('admin.accounts.kiro.regionPlaceholder')" />
            </div>
            <div>
              <label class="input-label">{{ t('admin.accounts.kiro.authRegionLabel') }}</label>
              <input v-model="editKiroAuthRegion" type="text" class="input font-mono" :placeholder="t('admin.accounts.kiro.authRegionPlaceholder')" />
            </div>
            <div>
              <label class="input-label">{{ t('admin.accounts.kiro.apiRegionLabel') }}</label>
              <input v-model="editKiroApiRegion" type="text" class="input font-mono" :placeholder="t('admin.accounts.kiro.apiRegionPlaceholder')" />
            </div>
            <div>
              <label class="input-label">{{ t('admin.accounts.kiro.machineIdLabel') }}</label>
              <input v-model="editKiroMachineId" type="text" class="input font-mono" :placeholder="t('admin.accounts.kiro.machineIdPlaceholder')" />
            </div>
          </div>
        ...
        <!-- Model Restriction Section (Kiro: whitelist / mapping, Anthropic-compatible) -->
      ...
      <!-- API Key fields (only for apikey type; Kiro has its own fields) -->
          ...
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                ...
                poolModeEnabled ? 'bg-emerald-500' : 'bg-gray-200 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
        ...
        <div class="border-t border-gray-200 pt-4 dark:border-dark-600">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                customErrorCodesEnabled ? 'bg-emerald-500' : 'bg-gray-200 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
        ...
        >
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                headerOverrideEnabled ? 'bg-emerald-500' : 'bg-gray-200 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
      ...
      <div class="border-t border-gray-200 pt-4 dark:border-dark-600 space-y-4">
        <div class="mb-3 flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
              tempUnschedEnabled ? 'bg-emerald-500' : 'bg-gray-200 dark:bg-dark-600'
            ]"
          >
            <span
              :class="[
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
              interceptWarmupRequests ? 'bg-emerald-500' : 'bg-gray-200 dark:bg-dark-600'
            ]"
          >
            <span
              :class="[
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
              openaiPassthroughEnabled ? 'bg-emerald-500' : 'bg-gray-200 dark:bg-dark-600'
            ]"
          >
            <span
              :class="[
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
              anthropicPassthroughEnabled ? 'bg-emerald-500' : 'bg-gray-200 dark:bg-dark-600'
            ]"
          >
            <span
              :class="[
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
              codexCLIOnlyEnabled ? 'bg-emerald-500' : 'bg-gray-200 dark:bg-dark-600'
            ]"
          >
            <span
              :class="[
        ...
        >
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
              codexCLIOnlyAppServerEnabled ? 'bg-emerald-500' : 'bg-gray-200 dark:bg-dark-600'
            ]"
          >
            <span
              :class="[
      ...
      <div>
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
              autoPauseOnExpired ? 'bg-emerald-500' : 'bg-gray-200 dark:bg-dark-600'
            ]"
          >
            <span
              :class="[
        ...
        <div class="space-y-2">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                autoPause5hDisabled ? 'bg-emerald-500' : 'bg-gray-200 dark:bg-dark-600'
              ]"
        ...
        <div class="space-y-2">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                autoPause7dDisabled ? 'bg-emerald-500' : 'bg-gray-200 dark:bg-dark-600'
              ]"
        ...
        <div class="rounded-lg border border-gray-200 p-4 dark:border-dark-600">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                windowCostEnabled ? 'bg-emerald-500' : 'bg-gray-200 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-gray-200 p-4 dark:border-dark-600">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                sessionLimitEnabled ? 'bg-emerald-500' : 'bg-gray-200 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-gray-200 p-4 dark:border-dark-600">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                rpmLimitEnabled ? 'bg-emerald-500' : 'bg-gray-200 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-gray-200 p-4 dark:border-dark-600">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                tlsFingerprintEnabled ? 'bg-emerald-500' : 'bg-gray-200 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-gray-200 p-4 dark:border-dark-600">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                sessionIdMaskingEnabled ? 'bg-emerald-500' : 'bg-gray-200 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-gray-200 p-4 dark:border-dark-600">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                cacheTTLOverrideEnabled ? 'bg-emerald-500' : 'bg-gray-200 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-gray-200 p-4 dark:border-dark-600">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                customBaseUrlEnabled ? 'bg-emerald-500' : 'bg-gray-200 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
...
// Kiro credential edit inputs (secrets are blank => keep existing value)
const editKiroAuthMethod = ref<KiroAuthMethod>('social')
const editKiroAccessToken = ref('')
const editKiroRefreshToken = ref('')
const editKiroProfileArn = ref('')
const editKiroRegion = ref('')
...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (props.account.platform === 'kiro') {
      ...
      const kiroInputs: KiroCredentialInputs = {
        accountType: props.account.type === 'apikey' ? 'apikey' : 'oauth',
        authMethod: editKiroAuthMethod.value,
        accessToken: editKiroAccessToken.value,
        refreshToken: editKiroRefreshToken.value,
        profileArn: editKiroProfileArn.value,
        region: editKiroRegion.value,
