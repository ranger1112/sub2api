...
func init() {
	...
	// usagelogDescKiroCreditUsage is the schema descriptor for kiro_credit_usage field.
	usagelogDescKiroCreditUsage := usagelogFields[27].Descriptor()
	// usagelog.DefaultKiroCreditUsage holds the default value on creation for the kiro_credit_usage field.
	usagelog.DefaultKiroCreditUsage = usagelogDescKiroCreditUsage.Default.(float64)
