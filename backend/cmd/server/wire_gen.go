...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	openAICapacityQuarantineStore := repository.NewOpenAICapacityQuarantineStore(redisClient)
	openAIGatewayService := service.NewOpenAIGatewayServiceWithCapacity(accountRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, userGroupRateRepository, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, rateLimitService, billingCacheService, httpUpstream, deferredService, openAITokenProvider, grokTokenProvider, modelPricingResolver, channelService, balanceNotifyService, settingService, serviceUserPlatformQuotaRepository, openAICapacityQuarantineStore)
	...
	checkInRewardTierRepository := repository.NewCheckInRewardTierRepository(client)
	checkInService := service.NewCheckInService(checkInRepository, checkInRewardTierRepository, userRepository, settingRepository, billingCacheService, apiKeyAuthCacheInvalidator)
	...
	kiroHTTPClientFactory := provideKiroHTTPClientFactory()
	clientConfig := provideKiroClientConfig()
	kiroOAuthService := service.NewKiroOAuthService(proxyRepository, kiroHTTPClientFactory, clientConfig)
	...
	kiroQuotaFetcher := service.NewKiroQuotaFetcher(kiroTokenProvider, kiroHTTPClientFactory, clientConfig)
	...
	accountTestService := service.ProvideAccountTestService(accountRepository, geminiTokenProvider, claudeTokenProvider, grokTokenProvider, antigravityGatewayService, httpUpstream, configConfig, tlsFingerprintProfileService, kiroQuotaFetcher, openAIGatewayService, settingService, pluginManager)
	crsSyncService := service.NewCRSSyncService(accountRepository, proxyRepository, oAuthService, openAIOAuthService, geminiOAuthService, configConfig)
	accountHandler := admin.ProvideAccountHandler(adminService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, rateLimitService, accountUsageService, accountTestService, concurrencyService, crsSyncService, sessionLimitCache, rpmCache, compositeTokenCacheInvalidator, kiroOAuthService, grokQuotaService)
	...
	checkInAdminService := service.NewCheckInAdminService(checkInRewardTierRepository, settingRepository, checkInRepository)
	adminCheckInHandler := admin.NewCheckInHandler(checkInAdminService)
	...
	cacheTracker := service.ProvideKiroCacheTracker()
	kiroGatewayService := service.NewKiroGatewayService(kiroTokenProvider, kiroHTTPClientFactory, clientConfig, cacheTracker, rateLimitService, accountRepository)
