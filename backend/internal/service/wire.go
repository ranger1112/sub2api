...
func ProvideTokenRefreshService(
	...
	// 注册 Kiro 后台刷新器（此前 Kiro 只在请求热路径按需刷新，无后台主动刷新/禁用）
	svc.SetKiroRefresher(NewKiroTokenRefresher(kiroOAuthService))
...
var ProviderSet = wire.NewSet(
	...
	NewAdminService,
	NewGatewayService,
	NewOpenAIGatewayServiceWithCapacity,
